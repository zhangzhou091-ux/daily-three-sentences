...
export const StatisticsSection: React.FC<StatisticsSectionProps> = React.memo(({ sentences, onImportClick, importStatus }) => {
  const stats = useMemo(() => {
      ...
      <div className="apple-card p-10 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6 text-center md:text-left">
            ...
            <div className="h-48 min-h-48 relative flex justify-center">
          ...
          <div className="space-y-6">
            ...
            <div className="h-48 min-h-48 flex justify-center">
