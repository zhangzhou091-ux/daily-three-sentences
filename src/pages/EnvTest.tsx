      ...
      <div className="space-y-4">
        <div className="p-4 bg-blue-50 rounded-lg">
          ...
          <div className="mt-2 space-y-2 text-sm">
            ...
            <p><strong>KEY:</strong> <code className="bg-white px-2 py-1 rounded">{getSupabaseConfig().ANON_KEY ? '✅ 已设置' : '❌ 未设置'}</code></p>
            <p><strong>长度:</strong> {getSupabaseConfig().ANON_KEY ? `${getSupabaseConfig().ANON_KEY.length} 字符` : 'N/A'}</p>
          </div>
        </div>
