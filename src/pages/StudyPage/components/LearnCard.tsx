...
interface LearnCardProps {
  ...
  isAnimatingLearned: boolean;
  animatingLearnedId: string | null;
}
  ...
  return (
    <div className="w-full max-w-2xl mx-auto perspective-1000">
      ...
      >
        ...
        <div className={`absolute w-full h-full backface-hidden rotate-y-180 ${isAnimatingLearned && animatingLearnedId === sentence.id ? 'animate-bounce' : ''}`}>
          <div className="apple-card p-8 h-full flex flex-col justify-between bg-gradient-to-br from-green-50 to-white">
            <div className="flex justify-between items-start">
